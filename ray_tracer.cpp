...
int main()
{
  ...
  //create small sphere in middle of screen and an extremely large sphere for the floor
  ...
  //ray tracing algorithm  - send rays for every possible coordinate
